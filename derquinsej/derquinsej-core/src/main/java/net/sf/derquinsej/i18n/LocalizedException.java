...
/**
 * Exception with a localized message.
 * @author Andres Rodriguez
 */
@SuppressWarnings("serial")
public abstract class LocalizedException extends Exception implements Localized<String> {
	/** Localized message. */
	private final LocalizedMessage message;

	protected LocalizedException(LocalizedMessage message, Throwable cause) {
		super(cause);
