 ...
 * The timestamp is measured in in 100-nanosecond units since midnight, October 15, 1582 UTC.
 * Only 60 bits are significant.
 * 
...
public interface UUIDTimer {
	 ...
	 * This value is supposed to be constant for each timer, so it may be cached by clients.  
	 */
	long getResolution();
}
