...
public abstract class ForwardingTimingMap<K> extends ForwardingMap<K, Timing> implements TimingMap<K> {
	...
	/* (non-Javadoc)
	 * @see net.sf.derquinsej.stats.TimingMap#add(java.lang.Object, long, java.util.concurrent.TimeUnit)
	 */
	...
	/* (non-Javadoc)
	 * @see net.sf.derquinsej.stats.TimingMap#add(java.lang.Object, java.lang.Number, java.util.concurrent.TimeUnit)
	 */
